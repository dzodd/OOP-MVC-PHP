      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-body p-0">
            <form id="quickForm" action="?c=store" method="POST" enctype="multipart/form-data">
              <div class="card-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Name Product</label>
                  <input type="text" name="product-name" class="form-control" placeholder="Enter name product">
                </div>
                <div class="form-group">
                ...
                <div class="form-group" style="width: 150px; height:150px;position: relative;border-radius:100%">
                  <img src="Resource/img/" alt="Image Product" style="width: 100%; height:100%;border-radius:100%;z-index:-1" id="output-image">
                </div>
                <input  type="file" name="product-image" id="product-img">
                <!-- /.card-body -->
                <div class="card-footer">
                  <button name="buttonCreate" type="submit" class="btn btn-primary">Submit</button>
                </div>
            </form>
          </div>
        </div>
